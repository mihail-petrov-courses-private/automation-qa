...
#### 🚀 [**Среща 1**](22-22/meet-01/README.md) / **[10.06.2022]** - Въведение в WEB - HTML документи, тагове и елементи
  - Как работи браузъра;
  - XML / HTML и за какво ни трябва;
  - Базови HTML елементи;
  - Работа с HTML елементи в контекста на тестови сценарии.

#### 🚀 [**Среща 2**](22-22/meet-02/README.md) / **[12.06.2022]** - Въведение в WEB - Семантични тагове, списъци и формуляри
  - Семантична версия на HTML таговете;
  - Списъци
  - HTML формуляри.

#### 🚀 [**Среща 3**](22-22/meet-03/README.md) / **[17.06.2022]** - Въведение в програмирането с JavaScript
